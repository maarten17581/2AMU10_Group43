...
from team43_A1_code_cleanup.regionsudokuboard import RegionSudokuBoard
...
class SudokuAI(competitive_sudoku.sudokuai.SudokuAI):
    ...
    def minimax(self, board: RegionSudokuBoard, tabooMoves: List[TabooMove], depth: int, maximizingPlayer: bool, score: int,
        ...
        # Initialize the best score as bad as possible given if it is the maximizing or minimizing player
        ...
        # Running through all moves for the minimax step
        for move, cell in all_moves:
            ...
            # Split between maximizing or minimizing player
            if maximizingPlayer:
                ...
                # If a mistake was returned increase the mistake counter
                if eval == "mistake":
                    mistakeCount += 1
                else:
